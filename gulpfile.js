...
gulp.task(
  "sass",
  gulp.series("clean:css", function buildSass() {
    var sassOptions = {
...
gulp.task(
  "js",
  gulp.series("clean:js", function buildJS() {
...
gulp.task("inject", function doInjection() {
  var sources = gulp.src([PATHS.dest.cssFiles, PATHS.dest.jsFiles], {
    read: false,
  });
