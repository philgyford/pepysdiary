...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'registration_registrationprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.Person'], unique=True)),
    ...
    models = {
        ...
        u'registration.registrationprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['membership.Person']", 'unique': 'True'})
        }
    }
