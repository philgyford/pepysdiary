...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.comment_count'
        db.add_column('encyclopedia_topic', 'comment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.comment_count'
        db.delete_column('encyclopedia_topic', 'comment_count')
