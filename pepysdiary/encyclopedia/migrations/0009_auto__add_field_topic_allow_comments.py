...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.allow_comments'
        db.add_column(u'encyclopedia_topic', 'allow_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.allow_comments'
        db.delete_column(u'encyclopedia_topic', 'allow_comments')
