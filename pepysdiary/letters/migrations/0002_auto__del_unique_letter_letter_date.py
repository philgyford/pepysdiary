...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Letter', fields ['letter_date']
        db.delete_unique('letters_letter', ['letter_date'])


    def backwards(self, orm):
        # Adding unique constraint on 'Letter', fields ['letter_date']
        db.create_unique('letters_letter', ['letter_date'])
