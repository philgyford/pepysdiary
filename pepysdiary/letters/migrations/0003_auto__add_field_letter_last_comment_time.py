...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Letter.last_comment_time'
        db.add_column('letters_letter', 'last_comment_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Letter.last_comment_time'
        db.delete_column('letters_letter', 'last_comment_time')
