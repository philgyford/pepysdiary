...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.last_comment_time'
        db.add_column('indepth_article', 'last_comment_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.last_comment_time'
        db.delete_column('indepth_article', 'last_comment_time')
