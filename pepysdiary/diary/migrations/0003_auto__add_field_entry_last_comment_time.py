...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.last_comment_time'
        db.add_column('diary_entry', 'last_comment_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.last_comment_time'
        db.delete_column('diary_entry', 'last_comment_time')
