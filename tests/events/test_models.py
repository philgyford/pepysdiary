...
class DayEventModelsTestCase(TestCase):
    ...
    def test_ordering(self):
        ...
        event_1 = DayEventFactory(event_date=make_date("1660-01-01"))
        event_2 = DayEventFactory(event_date=make_date("1660-01-03"))
        event_3 = DayEventFactory(event_date=make_date("1660-01-02"))
    ...
    def test_old_dates(self):
        ...
        event = DayEventFactory(event_date=make_date("1660-01-02"))
